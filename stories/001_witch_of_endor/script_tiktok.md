...
---
## DIRECTOR NOTES
- **Hook [0:00–0:03]:** Text overlay appears BEFORE voice. Let it land. Then speak.
- **Pacing:** Fast through Saul's setup. DEAD SLOW on the prophecy line.
- **Music:** Nothing under first 5 sec. Low biblical underscore from 0:05. Swell on "screamed."
- **Visuals:** War camp at night... dark road... stone doorway... 
  dim firelight on a robed figure. NO Halloween witch aesthetics.
- **End card:** Channel name + "Subscribe for more buried Bible stories"
- **Captions:** Always on. Verify: Saul, Samuel, Gilboa, En-dor after auto-caption runs.

---
## KOKORO GENERATION SETTINGS (RTX 4060)
```
model: kokoro-v1.0
voice: am_michael (deep, authoritative) OR af_sarah (eerie, haunting)
speed: 0.92  ← slightly slower than default for dramatic effect
language: en-us
output: witch_of_endor_tiktok.wav
```
